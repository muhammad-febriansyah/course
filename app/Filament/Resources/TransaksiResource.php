...
use App\Filament\Resources\TransaksiResource\Widgets\StatsTransaksi;
...
class TransaksiResource extends Resource
{
    ...
    {
        return ['nota', 'user.name', 'kelas.title'];
    }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('qty')->label('Qty')->toggleable(),
    ...
    {
        return parent::getGlobalSearchEloquentQuery()->with(['user', 'kelas']);
    }
        ...
        return $infolist
            ->schema([
                Section::make('Detail Transaksi')
                    ->schema([
                        TextEntry::make('nota')->label('Order ID'),
