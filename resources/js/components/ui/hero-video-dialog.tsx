        ...
        <div className={cn("relative", className)}>
            ...
            >
                <img
                    ...
                    width={1902}
                    height={1100}
                    className="w-full h-[250px] md:h-[400px] lg:h-[450px] transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-3xl shadow-lg border"
                />
                <div className="absolute inset-0 flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out rounded-2xl">
                    <div className="flex items-center justify-center rounded-full bg-primary/10 backdrop-blur-md size-28">
                        <div
