        ...
        <footer className="bg-white">
            <div className="container px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
                    ...
                    <div className="grid grid-cols-1 col-span-1 gap-8 sm:grid-cols-2 lg:grid-cols-2">
                        <div>
                            <p className="text-lg font-semibold text-black">
                                Link <span className="text-biru">Terkait</span>
                            </p>
                        ...
                        <div>
                            <p className="text-lg font-semibold text-black">
                                Link <span className="text-biru">Lainnya</span>
                            </p>
                ...
                <p className="text-xs text-gray-500">
                    &copy; {new Date().getFullYear()}. {setting.site_name}. All
                    rights reserved.
                </p>
            </div>
        </footer>
