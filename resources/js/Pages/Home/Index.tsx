                ...
                <div className="container relative flex flex-col items-center justify-between py-16 mt-10 lg:mt-0 lg:py-44 lg:flex-row lg:space-y-0 lg:space-x-12">
                    ...
                    >
                        ...
                        <div className="flex flex-col space-y-4 md:flex-row md:space-x-3 md:space-y-0">
                            ...
                            <Link href={route("home.register")}>
                                <RainbowButton>Daftar Sekarang</RainbowButton>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center order-2 w-full pb-10 lg:order-2 md:order-1 lg:w-1/2 lg:justify-start">
                        <HeroVideoDialog
                            ...
                            thumbnailSrc={setting.thumbnail}
            ...
            <section data-aos="fade-down" className="py-10 bg-biruTua">
                <div className="container">
                    <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
                        ...
                        <div className="flex flex-col items-center justify-center font-bold gap-y-5">
                            <h1 className="flex items-center text-4xl text-white gap-x-1">
                                <NumberTicker
                                    value={totalstudent}
                                    className="text-4xl text-white"
                                />
